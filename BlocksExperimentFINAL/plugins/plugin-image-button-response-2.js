var jsPsychImageButtonResponse2 = (function (jspsych) {
    'use strict';
  
    const info = {
        name: "image-button-response-2",
        parameters: {
            ...
            // ANY CONTENT HERE WILL BE DISPLAYED ABOVE THE BUTTON //
            header: {
                type: jspsych.ParameterType.HTML_STRING,
                pretty_name: "Header",
                default: null,
    ...
    class ImageButtonResponsePlugin {
        ...
        trial(display_element, trial) {
            ...
            if (trial.render_on_canvas) {
                ...
                if (Array.isArray(trial.button_html)) {
                    if (trial.button_html.length == trial.choices.length) {
                        ...
                        console.error("Error in image-button-response-2 plugin. The length of the button_html array does not equal the length of the choices array");
                    }
                }
                else {
                ...
                if (trial.header !== null) {
                    display_element.insertAdjacentHTML("afterbegin", trial.header);
                }
            ...
            // CREATE A KEYBOARD LISTENER THAT PRESSES THE BUTTONS
            var keyboardListener = this.jsPsych.pluginAPI.getKeyboardResponse({
              callback_function: (o) => {
                const associatedButton = document.getElementById(
                  "jspsych-image-button-response-button-" + ["arrowleft", "arrowright"].findIndex((x) => x === o.key)
                );
                associatedButton.childNodes[0].classList.add("clicked");
                window.setTimeout(() => associatedButton.click(), 500);
              },
            ...
            for (var i = 0; i < trial.choices.length; i++) {
              const button = document.getElementById("jspsych-image-button-response-button-" + i) 
